...
dialogos ="[wave]como te habras dado cuenta, tu lapiz tiene usos[/page]cuando se caban, no te preocupes.[/wave][/page]" +
"[pulse]Solo encuentra otro lapiz y da[sprMouse,1] sobre el[/page}igual que para recoger el primero.[/pulse][/page]" +
"[wobble]Asi rellenaras la mina y podras seguir escribiendo[/page]¡sin miedo a quedarte sin grafito![/wobble][/page]" +
"[jitter]Asi que busca bien y mantente siempre listo.[/jitter]";
