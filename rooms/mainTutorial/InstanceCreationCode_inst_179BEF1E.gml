...
dialogos ="[wave]Atencion, Kinalerito.[/wave][/page]" +
"[pulse]En este campus hay tareas que te perseguiran sin descanso.[/pulse][/page]" +
"[wave]Pero eso no es todo.[/wave][/page]" +
"[pulse]Tambien existen los jefes: cosas de la vida cotidiana o hasta examenes.[/pulse][/page]" +
"[c_red]Estos son mucho mas dificiles que las tareas comunes.[/color][/page]" +
"[wobble]Pero tranquilo, Kinalerito, al final habra recompensa para quienes perseveren.[/wobble][/page] sigue tu camino, ve hacia kinal... aqui comienza tu aventura";
