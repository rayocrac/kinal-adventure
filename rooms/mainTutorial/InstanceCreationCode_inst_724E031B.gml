...
"[wobble]Para derrotarlas, deberas lanzar grafito.[/wobble][/page]" +
"[c_yellow]Haz click [sprMouse,1][/color] para disparar y eliminar esas tareas.[/page]" +
"[jitter]Solo asi podras avanzar y seguir con tu entrenamiento.[/jitter][/page] o evitalas si quieres, es tu descicion, pero tambien tu futuro";
